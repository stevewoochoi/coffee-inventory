    ...
    public byte[] generateOrderPdf(OrderPlan plan, List<OrderLine> lines, Supplier supplier, Store store) {
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream cs = new PDPageContentStream(document, page)) {
                ...
                cs.newLineAtOffset(margin, y);
                cs.showText("Order #" + plan.getId() + "  |  Date: " + (plan.getCreatedAt() != null ? plan.getCreatedAt().format(DATE_FMT) : "N/A"));
                cs.endText();
                y -= 16;
                ...
                cs.setFont(fontRegular, 11);
                cs.newLineAtOffset(margin, y);
                cs.showText("Name: " + (supplier.getName() != null ? supplier.getName() : "N/A"));
                cs.endText();
                y -= 15;
                ...
                cs.setFont(fontRegular, 11);
                cs.newLineAtOffset(margin, y);
                cs.showText("Name: " + (store.getName() != null ? store.getName() : "N/A"));
                cs.endText();
                y -= 30;
                ...
                cs.newLineAtOffset(margin, y);
                cs.showText("Generated by Coffee Inventory System  |  " + (plan.getCreatedAt() != null ? plan.getCreatedAt().format(DATE_FMT) : "N/A"));
                cs.endText();
            }
